    ...
    <html lang="en" suppressHydrationWarning>
      <body className={`${font.className} dark:bg-black`}>
        ...
        >
          ...
          <div className="absolute left-[-35rem] top-[-1rem] -z-10 h-[31.25rem] w-[50rem] rounded-full bg-[#fbd7d7] blur-[10rem] dark:bg-[#636894] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
          {children}
          <ThemeSwitch />
          <Footer />
        </ThemeContextProvider>
